 ...
 */
export type McpToolHandler<TParams extends Record<string, unknown> = Record<string, unknown>, TStorage = unknown> = (params: TParams, storage?: TStorage, context?: ToolContext) => Promise<McpToolResult>;
/**
 * Middleware function type.
 */
export type ToolMiddleware = (context: ToolContext, params: Record<string, unknown>, next: () => Promise<McpToolResult>) => Promise<McpToolResult>;
/**
 * Registered MCP tool.
 */
export interface McpTool<P extends Record<string, PropertySchema> = Record<string, PropertySchema>> {
