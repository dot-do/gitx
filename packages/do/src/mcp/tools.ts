...
import type { McpToolSchema, McpTool, McpToolResult, McpToolHandler } from './types'
 ...
 * git_status - Show repository status
 */
export const gitStatusToolSchema: McpToolSchema = {
  name: 'git_status',
 ...
 * git_log - Show commit history
 */
export const gitLogToolSchema: McpToolSchema = {
  name: 'git_log',
 ...
 * git_diff - Show differences
 */
export const gitDiffToolSchema: McpToolSchema = {
  name: 'git_diff',
 ...
 * git_show - Show objects
 */
export const gitShowToolSchema: McpToolSchema = {
  name: 'git_show',
 ...
 */
export const gitCommitToolSchema: McpToolSchema = {
  name: 'git_commit',
 ...
 * git_branch - Manage branches
 */
export const gitBranchToolSchema: McpToolSchema = {
  name: 'git_branch',
 ...
 */
export const gitCheckoutToolSchema: McpToolSchema = {
  name: 'git_checkout',
 ...
 */
export const gitAddToolSchema: McpToolSchema = {
  name: 'git_add',
 ...
 */
export const gitResetToolSchema: McpToolSchema = {
  name: 'git_reset',
 ...
 */
export const gitMergeToolSchema: McpToolSchema = {
  name: 'git_merge',
 ...
 */
export const gitRebaseToolSchema: McpToolSchema = {
  name: 'git_rebase',
 ...
 */
export const gitStashToolSchema: McpToolSchema = {
  name: 'git_stash',
 ...
 * git_tag - Manage tags
 */
export const gitTagToolSchema: McpToolSchema = {
  name: 'git_tag',
 ...
 * git_remote - Manage remotes
 */
export const gitRemoteToolSchema: McpToolSchema = {
  name: 'git_remote',
 ...
 */
export const gitFetchToolSchema: McpToolSchema = {
  name: 'git_fetch',
 ...
 */
export const gitPushToolSchema: McpToolSchema = {
  name: 'git_push',
 ...
 */
export const gitPullToolSchema: McpToolSchema = {
  name: 'git_pull',
 ...
 */
export const gitCloneToolSchema: McpToolSchema = {
  name: 'git_clone',
 ...
 */
export const gitInitToolSchema: McpToolSchema = {
  name: 'git_init',
 ...
 * git_blame - Show line-by-line authorship
 */
export const gitBlameToolSchema: McpToolSchema = {
  name: 'git_blame',
 ...
 */
export function requiresWriteAccess(
  toolName: string,
  ...
  if (CONDITIONAL_WRITE_TOOLS.has(toolName)) {
    ...
    if (toolName === 'git_remote') {
      return ['add', 'remove', 'rename', 'set-url'].includes(params.action as string)
    }
  }
 ...
 */
function createStubHandler(toolName: string): McpToolHandler {
  return async (): Promise<McpToolResult> => ({
 ...
 */
export const gitToolMap = new Map<string, McpTool>(
  gitTools.map(tool => [tool.schema.name, tool])
)
