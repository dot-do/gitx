...
export { gitx, createGitX, type GitXFn, type GitXPromise, type GitResult, type GitOptions, type GitContext, type AsyncFn, type GitRepository, type GitStatus, type GitRef, type GitAuthor, type CommitObject as GitCommitObject, type GitInitOptions, type GitCloneOptions, type GitCommitOptions, type GitLogOptions, type GitBranchOptions, type GitCheckoutOptions, type GitMergeOptions, type GitFetchOptions, type GitPullOptions, type GitPushOptions, type GitDiffOptions, type MergeResult, type StatusFile, } from './fn';
