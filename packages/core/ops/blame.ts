 ...
 *
 * ```typescript
 * import { blame, formatBlame } from '@dotdo/gitx/ops'
 *
...
import type { GitIdentity, TreeEntry } from '../objects/types'
...
/**
 * Commit object for blame operations
 */
export interface BlameCommitObject {
  tree: string
  parents: string[]
  author: GitIdentity
...
/**
 * Tree object for blame operations
 */
export interface BlameTreeObject {
  entries: TreeEntry[]
}
...
export interface BlameStorage {
   ...
   */
  getCommit(sha: string): Promise<BlameCommitObject | null>
   ...
   */
  getTree(sha: string): Promise<BlameTreeObject | null>
