...
import { isGitHubEventType, isPushEventPayload, isPingEventPayload, isCreateEventPayload, isDeleteEventPayload, } from './types';
// ============================================================================
// Constants
// ============================================================================
...
export class GitHubWebhookHandler {
    ...
    async handle(request) {
        ...
        // Verify signature
        const isValid = await verifyGitHubSignature(payload, signature, this.env.GITHUB_WEBHOOK_SECRET);
        if (!isValid) {
     ...
     */
    async handlePush(payload, deliveryId) {
        ...
        try {
            ...
            const syncResponse = await stub.fetch(new Request('https://internal/sync', {
                method: 'POST',
                headers: {
 ...
 */
export function createGitHubWebhookHandler(env) {
    const handler = new GitHubWebhookHandler(env);
