 ...
 * ```
 */
export function r2PathFromLocation(location) {
 ...
 * ```
 */
export function r2PathWithPrefix(location, prefix) {
 ...
 * ```
 */
export function createR2PathConverter(prefix) {
    return (location) => r2PathWithPrefix(location, prefix);
}
//# sourceMappingURL=r2-path.js.map