 ...
 * ```
 */
export declare function r2PathFromLocation(location: string): string;
/**
 ...
 * ```
 */
export declare function r2PathWithPrefix(location: string, prefix?: string): string;
/**
 ...
 * ```
 */
export declare function createR2PathConverter(prefix?: string): (location: string) => string;
//# sourceMappingURL=r2-path.d.ts.map