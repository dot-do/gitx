 ...
 * ```
 */
export function isValidSha1(sha) {
 ...
 * ```
 */
export function isValidSha256(sha) {
 ...
 * ```
 */
export function assertValidSha1(sha, context) {
    if (!isValidSha1(sha)) {
 ...
 * ```
 */
export function assertValidSha256(sha, context) {
 ...
 * ```
 */
export function getShaType(sha) {
    if (isValidSha1(sha))
        return 'sha1';
    if (isValidSha256(sha))
        return 'sha256';
 ...
 * ```
 */
export function validateAndNormalizeSha(sha, context) {
    const normalized = normalizeSha(sha);
    assertValidSha(normalized, context);
    return normalized;
}
//# sourceMappingURL=sha-validation.js.map