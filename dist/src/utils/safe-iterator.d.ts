 ...
 */
/**
 * Options for safe iteration utilities.
 */
export interface SafeIteratorOptions {
    /**
    ...
    limit?: number;
    /**
     * Timeout in milliseconds for the entire iteration.
     * @default undefined (no timeout)
     */
    timeoutMs?: number;
    /**
     * Callback invoked when cleanup occurs.
 ...
 * ```
 */
export declare function safeIterate<T>(iterable: AsyncIterable<T>, options?: SafeIteratorOptions): AsyncGenerator<T, void, unknown>;
/**
 ...
 * ```
 */
export declare function collectAsync<T>(iterable: AsyncIterable<T>, options?: SafeIteratorOptions): Promise<T[]>;
/**
 ...
 * ```
 */
export declare function findAsync<T>(iterable: AsyncIterable<T>, predicate: (item: T) => boolean | Promise<boolean>, options?: SafeIteratorOptions): Promise<T | undefined>;
/**
 ...
 * ```
 */
export declare function takeAsync<T>(iterable: AsyncIterable<T>, count: number, options?: SafeIteratorOptions): Promise<T[]>;
/**
 ...
 * ```
 */
export declare function forEachAsync<T>(iterable: AsyncIterable<T>, processor: (item: T, index: number) => boolean | Promise<boolean>, options?: SafeIteratorOptions): Promise<number>;
/**
 ...
 * ```
 */
export declare function createDisposableIterator<T>(iterable: AsyncIterable<T>): {
 ...
 * ```
 */
export declare function withCleanup<Args extends unknown[], T>(generatorFn: (...args: Args) => AsyncGenerator<T>, name?: string): (...args: Args) => AsyncGenerator<T>;
//# sourceMappingURL=safe-iterator.d.ts.map