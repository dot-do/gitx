...
export { type StoredObjectResult, type BasicObjectStore, type RefObjectStore, type TreeDiffObjectStore, type ObjectStore, type CommitProvider, type BasicCommitProvider, type StorageBackend, type HashFunction, type CompressionProvider, type ValidationResult, type OperationResult, type WalkOptions, type FileEntry, type DiffEntry, } from './types';
