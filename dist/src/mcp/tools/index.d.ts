 ...
 * @module mcp/tools
 */
import type { Tool as BaseTool, ToolHandler as BaseToolHandler, ToolResponse, DoScope, DoPermissions } from '@dotdo/mcp';
 ...
 * }
 */
export type StorageToolHandlerFactory<TStorage, TInput> = (storage: TStorage) => TypedToolHandler<TInput>;
/**
 ...
 */
export declare function createStorageHandler<TStorage, TInput>(handlerFn: (storage: TStorage, input: TInput) => Promise<ToolResponse>): StorageToolHandlerFactory<TStorage, TInput>;
/**
 ...
 */
export declare function wrapHandler<TInput>(handler: TypedToolHandler<TInput>): MCPToolHandler;
/**
 ...
 */
export declare function toMCPTool<TInput>(tool: TypedMCPTool<TInput>): MCPTool;
/**
 ...
 */
export declare function createGitTools(git: GitBinding): MCPTool[];
/**
