...
export class MultiIndexManager {
     ...
     */
    _createEmptyShard(shardId, start, end) {
 ...
 * ```
 */
export function createMultiIndexManager(config) {
 ...
 * ```
 */
export function addPackIndexFromData(manager, packId, indexData) {
 ...
 */
export function batchLookupAcrossManagers(managers, shas) {
    const found = new Map();
