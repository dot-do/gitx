...
export default function Site() {
    return (_jsx(LandingPage, { logo: _jsx("span", { className: "font-bold text-xl", children: "gitx.do" }), header: {
            links: [
...
// git fetch origin`,
            ...
            socialLinks: [
                { name: 'GitHub', href: 'https://github.com/dot-do/gitx', icon: _jsx(SiGithub, { size: 20 }) },
                { name: 'X', href: 'https://x.com/dotdo_dev', icon: _jsx(SiX, { size: 20 }) },
            ],
        } }));
}
