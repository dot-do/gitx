 ...
 * Consumers should use for-await-of or manually call .return() when done.
 */
export declare function walkCommits(provider: ExtendedCommitProvider, start: string | string[], options?: TraversalOptions): AsyncGenerator<TraversalCommit, void, unknown>;
/**
