 ...
 *
 * ```typescript
 * import { createLightweightTag, createAnnotatedTag, listTags } from '@dotdo/gitx/ops'
 *
 ...
 * @module ops/tag
 */
import type { GitIdentity, ObjectType } from '../objects/types';
/**
 * Author type alias for tagger
 */
export type Author = GitIdentity;
/**
 ...
 */
export interface TagObjectStore {
    /**
 ...
 * Create a lightweight tag
 */
export declare function createLightweightTag(store: TagObjectStore, options: TagOptions): Promise<TagResult>;
/**
 * Create an annotated tag
 */
export declare function createAnnotatedTag(store: TagObjectStore, options: AnnotatedTagOptions): Promise<TagResult>;
/**
 ...
 * Delete a tag
 */
export declare function deleteTag(store: TagObjectStore, name: string, options?: DeleteTagOptions): Promise<DeleteTagResult>;
/**
 * List tags
 */
export declare function listTags(store: TagObjectStore, options?: TagListOptions): Promise<TagListEntry[]>;
/**
 * Get a tag by name
 */
export declare function getTag(store: TagObjectStore, name: string): Promise<TagInfo | null>;
/**
 * Verify a tag's signature
 */
export declare function verifyTag(store: TagObjectStore, name: string, options?: TagVerifyOptions): Promise<TagVerifyResult>;
/**
 ...
 */
export declare function isAnnotatedTag(store: TagObjectStore, name: string): Promise<boolean>;
/**
 * Get the target SHA for a tag
 */
export declare function getTagTarget(store: TagObjectStore, name: string): Promise<string>;
/**
 * Get the tagger info for a tag
 */
export declare function getTagTagger(store: TagObjectStore, name: string): Promise<Author | null>;
/**
 * Resolve a tag to its final commit SHA
 * Follows nested tags until reaching a commit
 */
export declare function resolveTagToCommit(store: TagObjectStore, name: string, depth?: number): Promise<string>;
