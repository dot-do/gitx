...
import { isValidSha, isValidMode } from './types';
// =============================================================================
 ...
 */
export function parseTreeEntries(content) {
    const entries = [];
    let offset = 0;
...
export class GitTree {
     ...
     */
    serialize() {
        const content = serializeTreeEntries(this.entries);
