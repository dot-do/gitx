 ...
 */
export function encodeOffset(offset: number): Uint8Array {
  const bytes: number[] = []
 ...
 * }
 */
export function calculateSimilarity(a: Uint8Array, b: Uint8Array): number {
 ...
 */
export const TYPE_ORDER: Record<number, number> = {
  1: 0, // OBJ_COMMIT
  2: 1, // OBJ_TREE
  3: 2, // OBJ_BLOB
  4: 3, // OBJ_TAG
 ...
 */
export const DEPENDENCY_TYPE_ORDER: Record<number, number> = {
  3: 0, // OBJ_BLOB
  2: 1, // OBJ_TREE
  4: 2, // OBJ_TAG
  1: 3, // OBJ_COMMIT
